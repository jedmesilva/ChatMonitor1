                  ...
                  <div className="absolute top-full left-0 mt-2 w-64 bg-card rounded-xl shadow-lg border border-border py-2 z-40" data-testid="vehicle-dropdown">
                    ...
                    <div className="px-4 pb-2">
                      <button
                        ...
                        className="w-full border-2 border-dashed border-primary/30 hover:border-primary/50 bg-primary/5 hover:bg-primary/10 rounded-xl p-4 transition-all duration-200 group focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-30"
                        data-testid="add-new-vehicle-option"
                      >
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 rounded-full bg-primary/10 group-hover:bg-primary/20 flex items-center justify-center transition-colors duration-200 flex-shrink-0">
                            <svg 
