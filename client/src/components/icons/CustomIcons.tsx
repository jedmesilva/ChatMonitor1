...
export const OdometerIcon = memo<IconProps>(({ size = 24, className = "" }) => (
...
export const FuelPumpIcon = memo<IconProps>(({ size = 24, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path 
...
export const FuelTankIcon = memo<FuelTankIconProps>(({ size = 24, className = "", level = 0.6 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
FuelPumpIcon.displayName = 'FuelPumpIcon';
FuelTankIcon.displayName = 'FuelTankIcon';